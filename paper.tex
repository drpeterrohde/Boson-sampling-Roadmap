...
From our predictions for the performance of classical computing 5 years into the future, in Fig.~\ref{fig:outperform} we relate these predicted performances to the scattershot boson-sampling protocol, to estimate the number of photons required to match this performance. We further estimate the number of photons required to outperform these benchmarks by a factor of 10, taking us into the regime of post-classical computation.

\begin{figure}[!htb]
%\includegraphics[width=\columnwidth]{outperform}
\caption{Performance of scattershot boson-sampling, showing data-points coinciding with our expectations for desktop PC and supercomputer performance in 5 years, as well as exceeding these anticipated performances by a factor of 10, which we use as a benchmark for the \emph{post-classical era}.} \label{fig:outperform}
\end{figure}

The number of photons required for these different benchmarks are summarised in Tab.~\ref{tab:benchmark_outperform}

\begin{table*}[!htb]
\begin{tabular}{|c|c|c|c|c|}
\hline
Classical computer in 5 years & Classical FLOPS & Single-photon efficiency ($\eta$) & Photon-number ($n$) & Single-photon fidelity ($F$) \\
\hline
\hline
Desktop PC & . & 99\% & . & . \\
 & & 99.9\% & . & . \\
...
Supercomputer & . & 99\% & . & . \\
 & & 99.9\% & . & . \\
\hline
Supercomputer (10x) & . & 99\% & . & . \\
 & & 99.9\% & . & . \\
\hline
\end{tabular} \caption{Comparison of the classical performance of different classical computers predicted in 5 year's time, their associated performance in FLOPS, respective number of photons required by a boson-sampler to match their performance.} \label{tab:benchmark_outperform}
\end{table*}
